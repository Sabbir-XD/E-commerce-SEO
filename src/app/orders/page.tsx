    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center border border-gray-100">
          ...
          <Link 
            href="/" 
            className="inline-flex items-center justify-center px-6 py-3 rounded-lg text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg"
          >
            Start Shopping
          </Link>
        </div>
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
              <ListOrdered className="h-8 w-8 text-indigo-600" />
              Order History
            </h1>
              ...
              {expandedOrders[order.id] && (
                <div className="border-t border-gray-200 px-5 py-4 bg-gray-50/50">
                  ...
                  <div className="mt-6 pt-5 border-t border-gray-200 flex justify-end">
                    ...
                    <button className="ml-3 px-4 py-2 bg-indigo-600 rounded-lg text-sm font-medium text-white hover:bg-indigo-700 transition shadow-sm">
                      Reorder
                    </button>
                  </div>
                </div>
